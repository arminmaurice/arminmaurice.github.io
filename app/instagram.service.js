    ...
    return {
        ...
        execute: function() {
            InstagramService = (function () {
                ...
                InstagramService.prototype.getGrams = function () {
                    var _this = this;
                    return this.http.get('https://api.instagram.com/v1/users/self/media/recent/?access_token=55558285.0835065.81980ecb75aa418e8425502473dbbb0e')
                        ...
                        .subscribe(function (data) { return _this.grams = data; }, function (err) { return _this.logError(err); }, function () { return console.log('get em'); });
                };
                InstagramService.prototype.logError = function (err) {
